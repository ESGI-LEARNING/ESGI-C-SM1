...
<head>
	...
	<title><?= config('app.name'); ?><?php if (isset($data)) { ?>- <?= $data->title; ?><?php } ?></title>
    <?php if (isset($data)) { ?>
	    <meta name="description" content="<?= $data->metadescription; ?>"><?php } else { ?>
	    <meta name="description" content="<?= config('app.name'); ?>"><?php } ?>
    <?= assetLoader(); ?>
